...
# the '@' sign. Besides lowercase letters, the email may contain one or more '.' or 
# '+'. 
# 
#  
...
# sign will be ignored. This allows certain emails to be filtered. Note that this 
...
#  
# 
#  Related Topics Array Hash Table String 👍 2665 👎 335
...
class Solution(object):
    def numUniqueEmails(self, emails):
        ...
        for email in emails:
            ...
            if "+" in parts[0]:
                parts = [parts[0].split("+")[0]] + parts[1:]
            new_email = "@".join(parts)
            if new_email not in email_dict:
